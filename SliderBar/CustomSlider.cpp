...
void CustomSlider::SetSliveRoundValue(int x_value, int y_value)
{
	 this->round_value_x = x_value;
	 this->round_value_y = y_value;
}

void CustomSlider::SetHanderLabelProperty(QFont font, QColor font_color, QColor back_color)
{
...
void CustomSlider::SetHanderLabelRoundValue(int border_x_value, int border_y_value)
{
