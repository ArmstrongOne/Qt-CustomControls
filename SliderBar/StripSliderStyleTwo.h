...
namespace Ui
{
	class StripSliderStyleTwo;
}
class SLIDERBAR_EXPORT StripSliderStyleTwo : public QWidget
{
	Q_OBJECT

public:
	StripSliderStyleTwo(QWidget *parent = Q_NULLPTR);
	~StripSliderStyleTwo();
	/*****************必要初始化接口*****************/
	//-----------------------滚动条主体设置-----------------------
	//设置滚动条，杆子的宽度
	...
	//---------------类特有,设置上下方三角宽度---------------------
	void SetTriangleWidth(int triangle_width);
