...
void StripSliderStyleTwo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        StripSliderStyleTwo *_t = static_cast<StripSliderStyleTwo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (StripSliderStyleTwo::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StripSliderStyleTwo::ValueChange)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject StripSliderStyleTwo::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StripSliderStyleTwo.data,
      qt_meta_data_StripSliderStyleTwo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StripSliderStyleTwo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StripSliderStyleTwo.stringdata0))
        return static_cast<void*>(const_cast< StripSliderStyleTwo*>(this));
