...
QT_MOC_LITERAL(3, 26, 9) // "cur_value"

    },
    "CustomSlider\0ValueChange\0\0cur_value"
};
...
void CustomSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomSlider::ValueChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomSlider::ValueChange(int _t1)
{
