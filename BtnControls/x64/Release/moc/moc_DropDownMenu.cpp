...
void DropDownMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DropDownMenu *_t = static_cast<DropDownMenu *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DropDownMenu::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DropDownMenu::OptionChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DropDownMenu::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DropDownMenu.data,
      qt_meta_data_DropDownMenu,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DropDownMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DropDownMenu.stringdata0))
        return static_cast<void*>(const_cast< DropDownMenu*>(this));
