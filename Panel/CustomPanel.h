...
private:
	...
	QColor panel_color; //盘颜色
	QFont scale_font;    //刻度字体
	QColor scale_number_color;  //刻度数字颜色
	QColor scale_color;    //刻度线颜色

	int space_border_scalenum; //刻度到仪表盘边框距离
	...
	int major_count;   //大刻度数量
	int minor_count;   //小刻度数量

	int min_value;    //最小值
	int max_value;    //最大值

	int start_angle;   //开始角度
	int end_angle;     //结束角度
	...
	//中心点
	int center_radius;    //中心圆半径

	//指针
	int pointer_width;    //指针宽度
	int pointer_length;   //指针长度
